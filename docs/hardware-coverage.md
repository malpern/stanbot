...
| --- | --- | --- | --- |
| Head pan servo | Calibrate safe range and direction; verify smooth bounded motion and stop behavior. | Bounded controller prepared; disabled pending calibration | Custom: No. Factory Move To Home produced user-observed centering on side USB, 2026-09-14; individual-axis range and feedback remain unverified. |
